            ...
            function delivery_check(){
                ...
                if (window.time_compare > new Date()){
                    if(new Date() > window.time_delivering){
                        //alert("Delivering!");
                        document.getElementById("orderstatus").innerHTML = "Delivering! <br> Estimated delivery time: " + window.time_compare;   //This one is 6 hours before expected delivery completion
                    }else{
                        //alert("Processing!");
                        document.getElementById("orderstatus").innerHTML = "Processing! <br> Estimated delivery time: " + window.time_compare;   //This one is 24~6 hours before expected delivery completion
                    }

                }else {
                    //alert("Delivered!");
                    document.getElementById("orderstatus").innerHTML = "Delivered!<br> Delivery time: " + window.time_compare;        //This is when the current datetime is more than the expected delivery completion
                }
